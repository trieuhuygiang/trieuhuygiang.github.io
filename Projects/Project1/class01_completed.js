...
const vertices = new Float32Array([
    // Triangle 1 (scaled by 2)
    0.0, 0.5, 0.0,    // Top vertex
    -0.5, 0.0, 0.0,   // Left vertex
    0.5, 0.0, 0.0,    // Right vertex

    // Triangle 2 (scaled by 2)
    0.6 * 2, 0.5, 0.0,    // Top vertex
    0.35 * 2, 0.0, 0.0,   // Left vertex
    0.85 * 2, 0.0, 0.0    // Right vertex
]);
...
const fsSource = `
    ...
    void main() {
        float colorR = abs(cos(uTimeFrag  * 3.0));
        ...
        cord = matrix * cord;
        float colorG = abs(sin(cord.x * 85.0));
        float colorB = abs(cos(cord.y * 45.0));
